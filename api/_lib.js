// Shared helpers and curated tracks for serverless API
    ...
    for (const section of sections) {
      ...
      for (const item of items) {
        if (item.videoRenderer) {
          ...
          if (videoId) {
            videos.push({ id: videoId, title, artist, duration: durationMs, thumbnail: `https://i.ytimg.com/vi/${videoId}/hqdefault.jpg`, genre: 'Streaming' });
          }
        }
      }
    }
